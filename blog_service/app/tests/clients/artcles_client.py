...
class ArticleClient:
    ...
    async def get_all_user_articles(self, headers: Dict | None = None) -> Response:
    ...
    async def create_article(
        self, article_in: Dict, headers: Dict | None = None
    ) -> Response:
    ...
    async def update_article(
        self, article_slug: str, article_in: Dict, headers: Dict | None = None
    ) -> Response:
