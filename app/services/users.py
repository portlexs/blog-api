...
class UserService:
    ...
    def register_user(self, user_in: UserCreateRequest) -> User:
    ...
    def login_user(self, user_in: UserLoginRequest) -> Tuple[str, str]:
    ...
    def update_user(self, user: User, user_in: UserUpdateRequest) -> User:
